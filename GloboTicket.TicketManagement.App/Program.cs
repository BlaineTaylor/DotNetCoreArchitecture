...
namespace GloboTicket.TicketManagement.App
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            {
                BaseAddress = new Uri("http://local.globoticket.com:6565")
            });

            builder.Services.AddHttpClient<IClient, Client>(client => client.BaseAddress = new Uri("http://local.globoticket.com:6565"));
